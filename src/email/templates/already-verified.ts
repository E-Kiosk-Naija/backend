const ALREADY_VERIFIED = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
        ...
        <table class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.05); padding: 30px; width: 600px; max-width: 100%;">
          ...
          <tr>
            <td align="center" style="padding: 30px 20px 0;">
              <img src="https://cdn-icons-png.flaticon.com/512/3917/3917754.png" width="70" alt="Info Icon" style="margin-bottom: 20px;">
              <h2 style="color: #1e1e2f;">Email already verified</h2>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding: 20px 30px;">
              <p style="font-size: 16px; color: #5f6c7b;">
                Your email has already been confirmed. You can go ahead and log in to your account.
              </p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-bottom: 30px;">
              <a href="https://afrilab.ai/login" style="background-color: #4318FF; color: white; padding: 14px 28px; border-radius: 6px; text-decoration: none; font-weight: bold;">Log In</a>
            </td>
          </tr>
          <tr>
...
export default ALREADY_VERIFIED;
